    ...
    'work_experience.positions': [
      {
        ...
        tasks: [
          ...
          'Led the migration of the Web App project (80K LOC) to TypeScript (now 70.0% migrated) and TanStack Query, resulting in a huge reduction of bugs and far more confidence when refactoring.',
    ...
    'work_experience.positions': [
      {
        ...
        tasks: [
          ...
          'Lideré la migración del proyecto de aplicación web (80K LOC) a TypeScript (ahora migrado en un 70,0%) y TanStack Query, lo que resultó en una enorme reducción de errores y mucha más confianza al refactorizar.',
